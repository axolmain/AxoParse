...
/// <summary>
/// Mirrors the Rust parser's test_record_samples.rs — compares our XML output for specific
/// records against golden snapshots generated by the Rust evtx_dump binary.
...
public class SnapshotComparisonTests(ITestOutputHelper testOutputHelper)
{
    ...
    /// </summary>
    [Fact]
    public void SecurityEvtx_Record1_MatchesRustSnapshot()
    {
    ...
    /// </summary>
    [Fact]
    public void DirtySecurityEvtx_Record1_MatchesRustSnapshot()
    {
    ...
    /// </summary>
    [Fact]
    public void Capi2Evtx_Record1_MatchesRustSnapshot()
    {
    ...
    /// </summary>
    [Fact]
    public void ExchangeEvtx_Record1_MatchesRustSnapshot()
    {
    ...
    /// <summary>
    /// Verifies that key field values in the first record of security.evtx match the Rust snapshot
    /// exactly — a structural check that catches field-level rendering bugs even if whitespace differs.
    /// </summary>
    [Fact]
    public void SecurityEvtx_Record1_FieldValuesMatchRust()
    {
        ...
        testOutputHelper.WriteLine("[security.evtx record 1] All field values match Rust output");
    }
    ...
    /// </summary>
    [Fact]
    public void DirtySecurityEvtx_Record1_EventDataFieldsMatchRust()
    {
        ...
        testOutputHelper.WriteLine("[dirty security record 1] All EventData fields match Rust output");
    }
    ...
    /// </summary>
    [Fact]
    public void Capi2Evtx_Record1_UserDataFieldsMatchRust()
    {
        ...
        testOutputHelper.WriteLine("[CAPI2 record 1] All UserData fields match Rust output");
    }
    ...
    /// <summary>
    /// Loads a Rust-generated snapshot file from the Snapshots directory.
    /// </summary>
    private static string LoadSnapshot(string snapshotFileName)
    {
        string path = Path.Combine(AppContext.BaseDirectory, "RustTestImitation", "Snapshots", snapshotFileName);
    ...
    /// <summary>
    /// Compares actual XML output against the Rust golden snapshot.
    ...
    private void AssertXmlMatch(string expected, string actual, string label)
    {
        ...
        testOutputHelper.WriteLine($"[{label}] XML matches Rust snapshot");
    }
